...
import (
	...
	"github.com/ONSdigital/dis-routing-api-poc/service"
	serviceMock "github.com/ONSdigital/dis-routing-api-poc/service/mock"
	"github.com/ONSdigital/dis-routing-api-poc/store"
	storeMock "github.com/ONSdigital/dis-routing-api-poc/store/mock"
...
func TestRun(t *testing.T) {
	Convey("Having a set of mocked dependencies", t, func() {
		...
		mongoDBMock := &storeMock.StorerMock{
		...
		Convey("Given that all dependencies are successfully initialised", func() {
			...
			Convey("The checkers are registered and the healthcheck and http server started", func() {
				...
				So(initMock.DoGetHTTPServerCalls()[0].BindAddr, ShouldEqual, "localhost:29700")
