module github.com/ONSdigital/dis-routing-api-poc

go 1.24

// to avoid the following vulnerabilities:
//  - CVE-2024-45339 CWE-377: Insecure Temporary File
// replace github.com/golang/glog v1.2.3 => github.com/golang/glog v1.2.4

//  - CVE-2025-22869 CWE-770: Allocation of Resources Without Limits or Throttling
replace golang.org/x/crypto v0.33.0 => golang.org/x/crypto v0.36.0
